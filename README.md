...
## Debugging
Using the verbose option is very helpful for debugging, `python3 packscript.py c -v`
it will print out the Python version of your PackScript code, this lets you pinpoint exactly where your error is.
When there's an error in your packscript you should see a line that looks like: 
```
